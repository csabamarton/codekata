...
public class Deadlock {
	public static void main(String[] args) throws InterruptedException
	{
		...
		Thread t1 = new Thread(new SyncThreadWithDeadLock(obj1, obj2), "t1");
		Thread t2 = new Thread(new SyncThreadWithDeadLock(obj2, obj3), "t2");
		Thread t3 = new Thread(new SyncThreadWithDeadLock(obj3, obj1), "t3");
