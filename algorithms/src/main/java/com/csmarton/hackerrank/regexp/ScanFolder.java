...
public class ScanFolder {
	...
	public static void main(String[] args)
	{
		...
		ScanFolder me = new ScanFolder(nCores);
		me.scan("/Users/csabamarton/learn/hackerrank/algorithms/src/main/resources/scanfolder");

	}

	int[] threads;

	public ScanFolder(int numberOfThreads)
	{
	...
	class FileExplorer implements Runnable {
		...
		public ScanFolder owner;
		private int id;

		public FileExplorer(int id, ScanFolder owner)
		{
			this.id = id;
			this.owner = owner;
		}
